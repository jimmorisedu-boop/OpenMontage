...
type Props = {
  project: ProjectState; mode: string; disabled?: boolean; onClose?: () => void;
...
export function Inspector(props: Props) {
  ...
  return <aside className="inspector" aria-label="Помощник и файлы">
    ...
    <div className="inspector-body">
      {tab === "assistant" ? <Conversation project={props.project} disabled={props.disabled} actions={{ answerQuestions: props.onQuestions, setEnhancements: props.onEnhancements, approvePlan: props.onApprove, cancelOperation: props.onCancel, resumeOperation: props.onResume, openArtifact: props.onOpenArtifact, createVersion: props.onVersion }}/>
